...
export default function StudyPlanCard() {
  ...
  return (
    <div className="bg-[#111620]/60 backdrop-blur-xl border border-white/[0.08] rounded-3xl p-8 shadow-2xl overflow-hidden relative group">
      ...
      <div className="flex justify-between items-center mb-8 relative z-10">
        ...
        <Link to="/plans" className="text-sm font-black text-blue-500 hover:text-blue-400 transition-colors uppercase tracking-widest">
          Tumunu Gor
        </Link>
      </div>
      ...
      <div className="space-y-4 relative z-10">
        {loading ? (
          ...
          <div className="py-12 flex flex-col items-center justify-center text-center space-y-4 bg-white/5 rounded-3xl border border-dashed border-white/10">
            ...
            <button onClick={() => navigate('/plans')} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-xl text-sm font-bold transition-all shadow-lg shadow-blue-600/20">
              Plan Olustur +
            </button>
          </div>
        ) : (
