...
public class PomodoroController {
    ...
    public ResponseEntity<PomodoroSessionResponse> startSession(
        ...
        return ResponseEntity.ok(pomodoroService.startSession(userId, taskId, category));
    }
    ...
    public ResponseEntity<PomodoroSessionResponse> endSession(
            ...
            Authentication authentication) {
        UUID userId = UUID.fromString(authentication.getPrincipal().toString());
        return ResponseEntity.ok(pomodoroService.endSession(userId, id, durationMinutes));
    }
